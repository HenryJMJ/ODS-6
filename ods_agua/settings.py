...
# Carpeta para recolectar archivos estáticos al usar collectstatic (solo para producción)
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Carpetas donde están los archivos estáticos durante el desarrollo
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
